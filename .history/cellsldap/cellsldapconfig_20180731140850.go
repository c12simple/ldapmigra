...
func (c *Config) ConvertFromPydioConfig(pydioConfig map[string]interface{}) {
	...
	for i := 0; mappingLoop; i++ {
		...
		fmt.Println("")
		fmt.Println(MappingLdapParam + ":" +pydioConfig[MappingLdapParam])
		fmt.Println(MappingLdapParam + ":" +pydioConfig[MappingLocalType])
		fmt.Println(MappingLdapParam + ":" +pydioConfig[MappingLocalParam])
